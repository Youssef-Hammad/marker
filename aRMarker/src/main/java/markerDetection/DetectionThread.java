	...
	public synchronized void run() {
		while (true) {
			...
			if (stopRequest == true) {
				...
				boolean[] isVisible = new boolean[markerObjectMap.size()];
				...
				for (MarkerObject marker : markerObjectMap.values())
					marker.setVisible(isVisible[marker.getMyId()]);
