...
/**
 * Calibrator class, handles all the calibration logic.
 */
public class CameraCalibrator {
    private static final String TAG = "CalibratorClass";

    private final Size mPatternSize = new Size(4, 11);
    private final int mCornersSize = (int)(mPatternSize.width * mPatternSize.height);

    private boolean mPatternIsFound = false;
    ...
    /**
     * The Camera Matrix the calibrator will deduce.
     */
    private Mat mCameraMatrix = new Mat();

    /**
     * The Distortion Coefficient the calibrator will deduce.
     */
    ...
    /**
     * This constructor defines the Image Size, sets the Calibrator's flags and
     * defines the Camera Matrix as a 3x3 CV_64FC1 Matrix as well as the distortion coefficients as a
     * 5x1 CV_64FC1 Matrix
     * @param pWidth
     * @param pHeight
     */
    public CameraCalibrator(int pWidth, int pHeight) {
        mImgSize = new Size(pWidth, pHeight);
        ...
        Log.i(TAG, "Instantiated a calibrator");
    }

    /**
     * This method renders the chessboard corner points on-top of the original RGBA frame
     * @param rgbaFrame
     */
    private void drawPoints(Mat rgbaFrame) {
        Calib3d.drawChessboardCorners(rgbaFrame, mPatternSize, mCorners, mPatternIsFound);
    }
    ...
    /**
     * This method uses findCirclesGrid to determine whether or not the input contains a grid of circles.
     * If the input contains a grid of circles, the method locates the centers of the circles
     * and returns a non-zero value if <b>all</b> centers have been found.
     * Otherwise returns 0.
     * @param grayFrame
     */
    private void findPattern(Mat grayFrame) {
        mPatternIsFound = Calib3d.findCirclesGrid(grayFrame, mPatternSize,
                mCorners, Calib3d.CALIB_CB_ASYMMETRIC_GRID);
    }

    /**
     * This method processes each frame's gray values to find the aruco markers and draws the frame
    ...
    /**
     * This method calculates the positions of the board's corners.
     * @param corners
     */
    ...
    /**
     * This method calculates the Average Re-projection Error (MSE)
     * @param objectPoints
     * @param rvecs
     * @param tvecs
     * @param perViewErrors
    ...
    /**
     * This method performs the calibration step and updates <b>mCameraMatrix</b> and
     * <b>mDistortionCoefficients</b>.
     */
    public void calibrate() {
        ...
        Calib3d.calibrateCamera(objectPoints, mCornersBuffer, mImgSize,
